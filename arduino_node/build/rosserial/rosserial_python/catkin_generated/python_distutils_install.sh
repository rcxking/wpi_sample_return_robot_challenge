...
cd "/home/bryant/wpi_sample_return_robot_challenge/arduino_node/src/rosserial/rosserial_python"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/bryant/wpi_sample_return_robot_challenge/arduino_node/src/rosserial/rosserial_python/setup.py" \
    build --build-base "/home/bryant/wpi_sample_return_robot_challenge/arduino_node/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
