...
Node::Node(const cv::Mat visual,
...
#endif
  flannIndex(NULL),
  base2points_(tf::Transform::getIdentity(), pcl_conversions::fromPCL(point_cloud->header).stamp/*ros::Time(0,point_cloud->header.stamp)*/,ParameterServer::instance()->get<std::string>("base_frame_name"), point_cloud->header.frame_id),
  ...
  odom_transform_(tf::Transform::getIdentity(), pcl_conversions::fromPCL(point_cloud->header).stamp/*ros::Time(0,point_cloud->header.stamp)*/, "missing_odometry", point_cloud->header.frame_id),
  initial_node_matches_(0)
{
